    ...
    <Nav.ScreenLayout showTitle title='Box'>
      <UI.VerticalLayout constraint='scroll' padding={2}>
        ...
        <UI.Text variant='bodyMedium'>
          Box is a drawable container that wraps a singular content and applies flex, alignment, and spacing.
        </UI.Text>
        ...
        <UI.LabelText>Flex values for parent container.</UI.LabelText>
